            ...
            <div className="mt-3 p-3 w-96">
              <div className="space-y-6 px-5">
                ...
                <div className="text-center">
                  <button
                    className="rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-blue-400 focus:outline-none"
                    onClick={handleValidate}
                  >
                ...
                <div className="text-center">
                  <h4 className="text-xl font-semibold">Tip</h4>
                  <p className="">
                    <i>
                      After setting up your account, press F11 for full screen
                      mode
                    </i>
                  </p>
                </div>
